...
> On Docker you can alternatively scaffold this module manually with `./install.sh add-module outage-track` from the Portal repo, then register it in the Portal UI.
